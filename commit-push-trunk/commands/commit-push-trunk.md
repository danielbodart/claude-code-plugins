---
allowed-tools: Bash(git add:*), Bash(git status:*), Bash(git push:*), Bash(git commit:*), Bash(git rebase:*), Bash(git merge:*), Bash(git pull:*), Bash(git -C:*), Bash(git diff:*), Bash(git branch:*), Bash(git symbolic-ref:*), Bash(git worktree list:*), Bash(git worktree list), Bash(git config:*), Bash(git config --get:*), Bash(git checkout:*)
...
- You have the capability to call multiple tools in a single response. You MUST do steps 1-6 in a single message.
